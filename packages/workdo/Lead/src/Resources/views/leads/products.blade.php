    ...
    <div class="modal-body">
        <div class="row">
            <div class="col-12 form-group">
                ...
                {{ Form::select('products[]', $products,null, array('class' => 'form-control choices','id'=>'choices-multiple','multiple'=>'','required'=>'required')) }}
                <p class="text-danger d-none" id="product_validation">{{__('Products filed is required.')}}</p>
            </div>
        </div>
    </div>
    <div class="modal-footer">
    <button type="button" class="btn  btn-light" data-bs-dismiss="modal">{{__('Create')}}</button>
