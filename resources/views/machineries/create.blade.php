{{ Form::open(['route' => 'machineries.store', 'class' => 'needs-validation', 'novalidate', 'data-size' => 'xl']) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-4">
            ...
            {{ Form::text('machine_id', '', ['class' => 'form-control', 'readonly' => true, 'placeholder' => __('Will be auto-generated after save (e.g., MCH-023)')]) }}
        </div>
        ...
        <div class="form-group col-md-4">
            ...
            {{ Form::text('name', '', ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Enter Machinery Name')]) }}
        ...
        <div class="form-group col-md-4">
            ...
            {{ Form::text('vehicle_number', '', ['class' => 'form-control', 'required' => 'required', 'placeholder' => __('Enter Machine Number')]) }}
        ...
        <div class="form-group col-md-4">
            ...
            {{ Form::text('model_number', '', ['class' => 'form-control', 'placeholder' => __('Enter Model Number')]) }}
        ...
        <div class="form-group col-md-4">
            ...
            {{ Form::text('manufacturer', '', ['class' => 'form-control', 'placeholder' => __('Enter Manufacturer')]) }}
        ...
        <div class="form-group col-md-4">
            ...
            {{ Form::select('operational_status', [
                ...
                'breakdown' => 'Breakdown',
                'scrap' => 'Scrap'
            ], 'active', ['class' => 'form-control', 'required' => 'required']) }}
        ...
        <div class="form-group col-md-8">
            ...
            {{ Form::select('site_id', $sites, null, ['class' => 'form-control', 'placeholder' => __('Select Current Site')]) }}
        ...
        <div id="rental_fields" style="display: none;">
            ...
            <div class="row">
                ...
                {{ Form::select('rate_type', [
                    ...
                    'daily' => 'Daily',
                    'monthly' => 'Monthly'
                ], null, ['class' => 'form-control', 'placeholder' => __('Select Rate Type')]) }}
            ...
            <div class="form-group col-md-4">
                ...
                {{ Form::number('rate', '', ['class' => 'form-control', 'step' => '0.01', 'placeholder' => __('Enter Rate')]) }}
            ...
            <div class="form-group col-md-4">
                ...
                {{ Form::number('minimum_billing_hours', '', ['class' => 'form-control', 'step' => '0.01', 'placeholder' => __('Enter Minimum Billing Hours')]) }}
            ...
            <div class="form-group col-md-4">
                ...
                {{ Form::number('number_of_operators', '', ['class' => 'form-control', 'placeholder' => __('Enter Number of Operators')]) }}
        ...
        <div id="owned_fields" style="display: none;">
            ...
            <div class="form-group col-md-4">
                ...
                {{ Form::number('purchase_value', '', ['class' => 'form-control', 'step' => '0.01', 'placeholder' => __('Enter Purchase Value')]) }}
            ...
            <div class="form-group col-md-4">
                ...
                {{ Form::date('insurance_due_date', '', ['class' => 'form-control']) }}
            ...
            <div class="form-group col-md-4">
                ...
                {{ Form::date('puc_due_date', '', ['class' => 'form-control']) }}
            ...
            <div class="form-group col-md-4">
                ...
                {{ Form::date('fitness_due_date', '', ['class' => 'form-control']) }}
            ...
            <div class="form-group col-md-4">
                ...
                {{ Form::date('last_service_date', '', ['class' => 'form-control']) }}
            ...
            <div class="form-group col-md-4">
                ...
                {{ Form::date('maintenance_schedule', '', ['class' => 'form-control']) }}
        ...
        <div class="form-group col-md-4">
            ...
            {{ Form::textarea('remarks', '', ['class' => 'form-control', 'rows' => 2, 'placeholder' => __('Enter Remarks')]) }}
        ...
        <div class="form-group col-md-4">
            ...
            {{ Form::text('capacity', '', ['class' => 'form-control', 'placeholder' => __('Enter Capacity')]) }}
