...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('plans', function (Blueprint $table) {
            ...
            $table->string('number_of_user', 255)->nullable();
            ...
            $table->double('price_per_workspace_monthly')->default(0);
            $table->double('price_per_workspace_yearly')->default(0);
            $table->longText('modules')->nullable();
            $table->integer('trial')->default(0);
            $table->string('trial_days', 255)->nullable();
            $table->string('number_of_workspace', 255)->nullable();
            $table->timestamps();
        });
    }
