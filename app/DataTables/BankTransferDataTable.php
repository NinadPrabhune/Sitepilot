...
class BankTransferDataTable extends DataTable
{
    ...
    {
        return \App\Models\BankTransferPayment::class;
    }
    ...
    {
        $rowColumn = ['created_at', 'user_id', 'price', 'status', 'attachment', 'action', 'checkbox'];

        return (new EloquentDataTable($query))
        ->addIndexColumn()
        ->addColumn('checkbox', function (BankTransferPayment $bank_transfer_payment) {
            return '<input type="checkbox" class="' . $this->getCheckboxClass() . ' form-check-input" value="' . $bank_transfer_payment->id . '">';
        })
