...
<?php echo e(Form::open(['route' => 'daily-progress-reports.store', 'class' => 'needs-validation', 'novalidate', 'files' => true])); ?>

<?php echo e(Form::hidden('activity_completed_id', $activity_completed_id ?? null)); ?>

<?php echo e(Form::hidden('site_id', $defaultSiteId ?? getActiveProject())); ?>
...
<div class="form-group col-md-3">
    <?php echo e(Form::label('machinery_id', __('Machinery Name'), ['class' => 'form-label'])); ?><?php if (isset($component)) { $__componentOriginalbba606fec37ea04333bc269e3e165587 = $component; } ?>
...
<?php endif; ?>
    <?php echo e(Form::select('machinery_id', ['' => __('Select Machinery')] + $machineryList->pluck('name', 'id')->toArray(), null, ['class' => 'form-control', 'required' => 'required', 'id' => 'machinery_id'])); ?>
        ...
        <div class="form-group col-md-3">
            <?php echo e(Form::label('owned_by_new', __('Owned By'), ['class' => 'form-label'])); ?><?php if (isset($component)) { $__componentOriginalbba606fec37ea04333bc269e3e165587 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbba606fec37ea04333bc269e3e165587 = $attributes; } ?>
<?php $component = App\View\Components\Required::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
            <?php echo e(Form::select('owned_by_new', [
                '' => __('Select Owned By'),
                'owned' => 'Owned',
                'rental' => 'Rental'
             ...
             <?php echo e(Form::hidden('owned_by', '')); ?>

        </div>

        
        <div class="form-group col-md-3">
            <?php echo e(Form::label('site_id_new', __('Current Site'), ['class' => 'form-label'])); ?><?php if (isset($component)) { $__componentOriginalbba606fec37ea04333bc269e3e165587 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbba606fec37ea04333bc269e3e165587 = $attributes; } ?>
<?php $component = App\View\Components\Required::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
            <?php echo e(Form::select('site_id_new', ['' => __('Select Site')] + $sites->toArray(), $defaultSiteId ?? getActiveProject(), ['class' => 'form-control', 'id' => 'site_id_new', 'disabled'=>'disabled'])); ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
            <?php echo e(Form::date('date', now(), ['class' => 'form-control', 'required' => 'required'])); ?>
        ...
        <div class="form-group col-md-4">
            ...
            <?php echo e(Form::number('machine_start_reading', null, ['class' => 'form-control', 'min' => 0, 'step' => '0.01','placeholder' => 'e.g. 100.00', 'onchange' => 'validateReadings()'])); ?>
        ...
        <div class="form-group col-md-4">
            <?php echo e(Form::label('machine_end_reading', __('Closing Reading'), ['class' => 'form-label'])); ?>

            <?php echo e(Form::number('machine_end_reading', null, ['class' => 'form-control', 'min' => 0, 'step' => '0.01','placeholder' => 'e.g. 100.00', 'onchange' => 'validateReadings()'])); ?>
        ...
        <div class="form-group col-md-4">
            ...
            <?php echo e(Form::number('machine_idle_reading', null, ['class' => 'form-control', 'min' => 0, 'step' => '0.01','placeholder' => 'e.g. 1.00', 'onchange' => 'validateReadings()'])); ?>
        ...
        <div class="form-group col-md-4">
            ...
            <?php echo e(Form::number('number_of_operators', null, ['class' => 'form-control', 'min' => 0, 'id' => 'number_of_operators'])); ?>
        ...
        <div class="form-group col-md-8">
            ...
            <?php echo e(Form::text('operator_names', null, ['class' => 'form-control', 'placeholder' => 'e.g. John Doe, Jane Smith'])); ?>
        ...
        <div class="form-group col-md-6 d-none">
            ...
            <?php echo e(Form::textarea('work_details', null, ['class' => 'form-control', 'rows' => 3])); ?>
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::file('consumption_file', ['class' => 'form-control', 'accept' => '.pdf,.jpg,.jpeg,.png,.doc,.docx'])); ?>

            <small class="text-muted"><?php echo e(__('Allowed: pdf, jpg, jpeg, png, doc, docx')); ?></small>
        </div>

        
        <div class="form-group col-md-6">
            <?php echo e(Form::label('maintenance_notes', __('Notes'), ['class' => 'form-label'])); ?>

            <?php echo e(Form::textarea('maintenance_notes', null, ['class' => 'form-control', 'rows' => 3])); ?>

        </div>

        <?php echo e(Form::hidden('consumption_type', 'fuel')); ?>

        <?php echo e(Form::hidden('activity_id', $activity_id ?? null)); ?>
                ...
                <div class="col-md-6">
                    <div class="alert alert-info mb-0">
                        ...
                        <div id="rate-type-explanation">
                            <small class="text-muted"><?php echo e(__('Select machinery to see rate calculation logic')); ?></small>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
        ...
        <div id="fuel-consumption-section">
            ...
            <div class="form-group col-md-12" id="fuel-consumption-form">
                ...
                <table class="table table-bordered mt-2" id="consumption-items-table">
                    <thead>
                        <tr>
                            <th style="width: 30%;"><?php echo e(__('Material')); ?></th>
...
<script src="<?php echo e(asset('js/dpr-validation-simple.js')); ?>"></script>

<script>
$(document).ready(function () {
    // Use raw JSON encoding to avoid Blade directive issues
    let materials = <?php echo $materials ? json_encode($materials) : '[]'; ?>;
    let machineryList = <?php echo $machineryList ? json_encode($machineryList->keyBy('id')) : '{}'; ?>;
    ...
    function loadPreviousReading(machineryId) {
        ...
        $.ajax({
            url: '<?php echo e(route("daily-progress-reports.get-previous-reading")); ?>',
            method: 'GET',
            data: {
    ...
    function loadFuelStock(siteId) {
        if (!siteId) return;
        $.ajax({
            url: '<?php echo e(route("ajax.getStockBySiteForDailyConsumption")); ?>',
            method: 'GET',
            data: {site_id: siteId},
            success: function (response) {
    ...
    $('form.needs-validation').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?php echo e(route("daily-progress-reports.check-duplicate")); ?>',
            method: 'POST',
            data: {
                machinery_id: machineryId,
                date: date,
...
<?php /**PATH C:\wamp64\www\SitePilot\resources\views/daily-progress-reports/create-new.blade.php ENDPATH**/ ?>