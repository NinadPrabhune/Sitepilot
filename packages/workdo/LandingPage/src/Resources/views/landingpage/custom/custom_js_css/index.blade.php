                    ...
                    <div class="row align-items-center justify-content-between p-3">
                        <div class="mb-5 col-6">
                            <div class="form-group">
                                ...
                                {{ Form::textarea('landingpage_custom_js', isset($settings['landingpage_custom_js']) ? $settings['landingpage_custom_js'] : '', ['class' => 'form-control', 'required' => 'required', 'id'=>'topbar_notification']) }}
                        ...
                        <div class="mb-5 col-6">
                            <div class="form-group">
                                ...
                                {{ Form::textarea('landingpage_custom_css', isset($settings['landingpage_custom_css']) ? $settings['landingpage_custom_css'] : '', ['class' => 'form-control', 'required' => 'required', 'id'=>'topbar_notification']) }}
                                <div class=" text-xs text-secondary mt-1">
