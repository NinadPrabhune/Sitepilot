...
<!--            <a href="#"  class="btn btn-sm btn-primary me-2" data-ajax-popup="true" data-title="{{__('Payment Import')}}" data-url="{{ route('machineries.file.import') }}"  data-toggle="tooltip" title="{{ __('Import') }}"><i class="ti ti-file-import"></i>
         </a>-->
    {{--  @endpermission --}}
    {{--  @permission('warehouse create') --}}
    {{-- <a data-size="xl" data-url="{{ route('payments-module.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Create')}}" data-title="{{__('Create Payment')}}"  class="btn btn-sm btn-primary">
