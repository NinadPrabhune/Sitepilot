<!--Brand Settings-->
<div id="site-settings" class="d-none">
...
<!--currency settings-->
<div class="card d-none" id="currency-setting-sidenav">
    <div class="card-header p-3">
...
@if (!empty(array_intersect($dependency, $active_module)))
    ...
    @endphp
    <div id="proposal-print-sidenav" class="card d-none">
        <div class="card-header p-3">
    ...
    @endphp
    <div id="invoice-print-sidenav" class="card d-none">
        <div class="card-header p-3">
    ...
    <div id="purchase-print-sidenav" class="card d-none">
        <div class="card-header p-3">
...
{{--<div id="purchase-order-setting-sidenav" class="card">
    {{ Form::open(['route' => ['company.settings.save'], 'enctype' => 'multipart/form-data', 'id' => 'setting-form']) }}
    @method('post')
    <div class="card">
        <div class="card-header p-3">
            <h5>{{ __('Purchase Order Settings') }}</h5>
            <small class="text-muted">{{ __('Manage your Purchase Order prefix and starting number') }}</small>
        </div>
        <div class="card-body border-bottom border-1 p-3 pb-0">
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        {{ Form::label('po_prefix', __('Prefix'), ['class' => 'form-label']) }}
                        {{ Form::text('po_prefix', isset($settings['po_prefix']) && !empty($settings['po_prefix']) ? $settings['po_prefix'] : 'PO', ['class' => 'form-control', 'placeholder' => 'Enter PO Prefix', 'maxlength' => 10]) }}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        {{ Form::label('po_starting_number', __('Starting Number'), ['class' => 'form-label']) }}
                        {{ Form::number('po_starting_number', isset($settings['po_starting_number']) && !empty($settings['po_starting_number']) ? $settings['po_starting_number'] : 1, ['class' => 'form-control', 'placeholder' => 'Enter Starting Number', 'min' => 1]) }}
                    </div>
                </div>
            </div>
        </div>
        <div class="card-body p-3">
            <div class="row">
                <div class="col-12 text-end">
                    {{ Form::button(__('Save Changes'), ['class' => 'btn btn-print-invoice btn-primary', 'type' => 'submit']) }}
                </div>
            </div>
        </div>
    </div>
...
{{-- Indent Settings --}}
{{--<div id="indent-setting-sidenav" class="card mt-3">
    {{ Form::open(['route' => ['company.settings.save'], 'enctype' => 'multipart/form-data', 'id' => 'indent-setting-form']) }}
    @method('post')
    <div class="card">
        <div class="card-header p-3">
            <h5>{{ __('Indent Settings') }}</h5>
            <small class="text-muted">{{ __('Manage your Indent prefix and starting number') }}</small>
        </div>
        <div class="card-body border-bottom border-1 p-3 pb-0">
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        {{ Form::label('indent_prefix', __('Prefix'), ['class' => 'form-label']) }}
                        {{ Form::text('indent_prefix', isset($settings['indent_prefix']) && !empty($settings['indent_prefix']) ? $settings['indent_prefix'] : 'IND', ['class' => 'form-control', 'placeholder' => 'Enter Indent Prefix', 'maxlength' => 10]) }}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        {{ Form::label('indent_starting_number', __('Starting Number'), ['class' => 'form-label']) }}
                        {{ Form::number('indent_starting_number', isset($settings['indent_starting_number']) && !empty($settings['indent_starting_number']) ? $settings['indent_starting_number'] : 1, ['class' => 'form-control', 'placeholder' => 'Enter Starting Number', 'min' => 1]) }}
                    </div>
                </div>
            </div>
        </div>
...
{{-- GRN Settings --}}
{{--<div id="grn-setting-sidenav" class="card mt-3">
    {{ Form::open(['route' => ['company.settings.save'], 'enctype' => 'multipart/form-data', 'id' => 'grn-setting-form']) }}
    @method('post')
    <div class="card">
        <div class="card-header p-3">
            <h5>{{ __('GRN Settings') }}</h5>
            <small class="text-muted">{{ __('Manage your GRN prefix and starting number') }}</small>
        </div>
        <div class="card-body border-bottom border-1 p-3 pb-0">
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        {{ Form::label('grn_prefix', __('Prefix'), ['class' => 'form-label']) }}
                        {{ Form::text('grn_prefix', isset($settings['grn_prefix']) && !empty($settings['grn_prefix']) ? $settings['grn_prefix'] : 'GRN-', ['class' => 'form-control', 'placeholder' => 'Enter GRN Prefix', 'maxlength' => 10]) }}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        {{ Form::label('grn_starting_number', __('Starting Number'), ['class' => 'form-label']) }}
                        {{ Form::number('grn_starting_number', isset($settings['grn_starting_number']) && !empty($settings['grn_starting_number']) ? $settings['grn_starting_number'] : 1, ['class' => 'form-control', 'placeholder' => 'Enter Starting Number', 'min' => 1]) }}
                    </div>
                </div>
            </div>
        </div>
...
{{-- Invoice Settings --}}
{{--<div id="invoice-setting-sidenav" class="card mt-3">
    {{ Form::open(['route' => ['company.settings.save'], 'enctype' => 'multipart/form-data', 'id' => 'invoice-setting-form']) }}
    @method('post')
    <div class="card">
        <div class="card-header p-3">
            <h5>{{ __('Invoice Settings') }}</h5>
            <small class="text-muted">{{ __('Manage your Invoice prefix and starting number') }}</small>
        </div>
        <div class="card-body border-bottom border-1 p-3 pb-0">
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        {{ Form::label('invoice_prefix', __('Prefix'), ['class' => 'form-label']) }}
                        {{ Form::text('invoice_prefix', isset($settings['invoice_prefix']) && !empty($settings['invoice_prefix']) ? $settings['invoice_prefix'] : 'INV-', ['class' => 'form-control', 'placeholder' => 'Enter Invoice Prefix', 'maxlength' => 10]) }}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        {{ Form::label('invoice_starting_number', __('Starting Number'), ['class' => 'form-label']) }}
                        {{ Form::number('invoice_starting_number', isset($settings['invoice_starting_number']) && !empty($settings['invoice_starting_number']) ? $settings['invoice_starting_number'] : 1, ['class' => 'form-control', 'placeholder' => 'Enter Starting Number', 'min' => 1]) }}
                    </div>
                </div>
            </div>
        </div>
...
{{-- Payment Settings --}}
{{--<div id="payment-setting-sidenav" class="card mt-3">
    {{ Form::open(['route' => ['company.settings.save'], 'enctype' => 'multipart/form-data', 'id' => 'payment-setting-form']) }}
    @method('post')
    <div class="card">
        <div class="card-header p-3">
            <h5>{{ __('Payment Settings') }}</h5>
            <small class="text-muted">{{ __('Manage your Payment prefix and starting number') }}</small>
        </div>
        <div class="card-body border-bottom border-1 p-3 pb-0">
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        {{ Form::label('payment_prefix', __('Prefix'), ['class' => 'form-label']) }}
                        {{ Form::text('payment_prefix', isset($settings['payment_prefix']) && !empty($settings['payment_prefix']) ? $settings['payment_prefix'] : 'PAY-', ['class' => 'form-control', 'placeholder' => 'Enter Payment Prefix', 'maxlength' => 10]) }}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        {{ Form::label('payment_starting_number', __('Starting Number'), ['class' => 'form-label']) }}
                        {{ Form::number('payment_starting_number', isset($settings['payment_starting_number']) && !empty($settings['payment_starting_number']) ? $settings['payment_starting_number'] : 1, ['class' => 'form-control', 'placeholder' => 'Enter Starting Number', 'min' => 1]) }}
                    </div>
                </div>
            </div>
        </div>
