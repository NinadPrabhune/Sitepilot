...
/**
 * @group Lead Stages
 * Endpoints for lead stage management
 */
class LeadStageApiController extends Controller
{
    ...
    /**
     * Store a new lead stage
     *
     * @bodyParam name string required Stage name. Example: Qualified
     ...
     * @bodyParam lead_stage_id integer optional Lead stage ID. Example: 1
