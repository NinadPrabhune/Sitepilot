<?php echo e(Form::open(['route' => 'daily-consumption.store', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'class' => 'needs-validation', 'novalidate'])); ?>
...
<div class="modal-body">
    ...
    <div class="row mb-3">
        <div class="form-group col-md-4">
            <?php echo e(Form::label('consumption_number', __('Consumption Number'), ['class' => 'form-label'])); ?> <?php if (isset($component)) { $__componentOriginalbba606fec37ea04333bc269e3e165587 = $component; } ?>
...
<?php endif; ?>
            <?php echo e(Form::text('consumption_number', $nextConsumptionNumber, ['class' => 'form-control', 'readonly' => true, 'required'])); ?>

        </div>
        <div class="form-group col-md-4">
            <?php echo e(Form::label('consumption_date', __('Consumption Date'), ['class' => 'form-label'])); ?> <?php if (isset($component)) { $__componentOriginalbba606fec37ea04333bc269e3e165587 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbba606fec37ea04333bc269e3e165587 = $attributes; } ?>
<?php $component = App\View\Components\Required::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
            <?php echo e(Form::date('consumption_date', date('Y-m-d'), ['class' => 'form-control', 'required'])); ?>

        </div>
        <div class="form-group col-md-4">
            <?php echo e(Form::label('site_id', __('Site'), ['class' => 'form-label'])); ?> <?php if (isset($component)) { $__componentOriginalbba606fec37ea04333bc269e3e165587 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbba606fec37ea04333bc269e3e165587 = $attributes; } ?>
<?php $component = App\View\Components\Required::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
            <?php echo e(Form::select('site_id', $sites->toArray(), $defaultSiteId ?? null, ['class' => 'form-control', 'required'])); ?>
    ...
    <div class="row mb-3">
        <div class="form-group col-md-3">
            <?php echo e(Form::label('consumption_type', __('Consumption Type'), ['class' => 'form-label'])); ?><?php if (isset($component)) { $__componentOriginalbba606fec37ea04333bc269e3e165587 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbba606fec37ea04333bc269e3e165587 = $attributes; } ?>
<?php $component = App\View\Components\Required::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
            <?php echo e(Form::select('consumption_type', [
                'all' => 'All Material',
                'fuel' => 'Fuel'
        ...
        <div class="form-group col-md-3" id="machinery_type_group" style="display: none;">
            <?php echo e(Form::label('machinery_type', __('Machinery Type'), ['class' => 'form-label'])); ?><?php if (isset($component)) { $__componentOriginalbba606fec37ea04333bc269e3e165587 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbba606fec37ea04333bc269e3e165587 = $attributes; } ?>
<?php $component = App\View\Components\Required::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
            <?php echo e(Form::select('machinery_type', [
                'own' => 'Own',
                'rental' => 'Rental'
        ...
        <div class="form-group col-md-6" id="machinery_id_group" style="display: none;">
            <?php echo e(Form::label('machinery_id', __('Machinery'), ['class' => 'form-label'])); ?> <?php if (isset($component)) { $__componentOriginalbba606fec37ea04333bc269e3e165587 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbba606fec37ea04333bc269e3e165587 = $attributes; } ?>
<?php $component = App\View\Components\Required::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php unset($__componentOriginalbba606fec37ea04333bc269e3e165587); ?>
<?php endif; ?>
            <?php echo e(Form::select('machinery_id', ['' => __('Select Machinery')] + $machineryOptions, null, ['class' => 'form-control', 'id' => 'machinery_id'])); ?>
    ...
    <div class="row mb-3">
        <div class="form-group col-md-12">
            <label class="form-label"><?php echo e(__('Consumption Details')); ?></label>
            ...
            <table class="table table-bordered mt-2" id="consumption-items-table">
                <thead>
                    <tr>
                        <th style="width: 40%;"><?php echo e(__('Material')); ?></th>
...
<div class="modal-footer">
    <a href="<?php echo e(route('daily-consumption.index')); ?>" class="btn btn-light"><?php echo e(__('Cancel')); ?></a>
...
$(document).ready(function () {
    let materialsFuel = <?php echo json_encode($materials_fules, 15, 512) ?>;
    let materialsAll = <?php echo json_encode($materials_all, 15, 512) ?>;
    let rowIndex = 0;

    function getMaterialOptions(materials) {
        let options = '<option value=""><?php echo e(__("Select Material")); ?></option>';
...
<?php /**PATH C:\wamp64\www\SitePilot\resources\views/daily-consumption/create.blade.php ENDPATH**/ ?>