...
Route::middleware(['web','auth','verified','PlanModuleCheck:Taskly'])->group(function ()
{
    ...
    Route::post('projects/{id}/task-board',[ProjectController::class,'taskStore'])->name('tasks.store');
    ...
    Route::post('projects/{id}/task-board/{tid}/reminder', [ProjectController::class,'sendTaskReminder'])->name('tasks.reminder');
