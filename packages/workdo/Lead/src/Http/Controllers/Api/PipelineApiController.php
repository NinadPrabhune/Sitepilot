...
/**
 * @group Lead Pipelines
 * Endpoints for lead pipeline management
 */
class PipelineApiController extends Controller
{
     ...
     *
     * @bodyParam name string required Pipeline name (max 20 chars). Example: Sales Pipeline
     * @bodyParam workspace_id integer required Workspace ID. Example: 1
     * @bodyParam pipeline_id integer optional Pipeline ID. Example: 1
