...
@permission('task manage')
        <div class="col-sm-auto">
            <a class="btn btn-sm btn-primary me-2" data-bs-toggle="tooltip" href="{{ route('projects.task.board', [$project->id]) }}"
            ...
            <div class="card-inner">
                <div class="card-content">
                    ...
                    <div class="btn-wrp d-flex gap-3">
                        ...
                        <a href="#" class="btn btn-primary " tabindex="0" data-size="lg" data-url="{{ route('projects.edit',$project->id) }}" data-ajax-popup="true" data-title="{{ __('Edit ') . $name }}" data-bs-toggle="tooltip"  title="{{__('Edit')}}" data-original-title="{{__('Edit')}}">
                ...
                <div class="status-info">
                    <div class="status-wrp">
                        ...
                        <p class="mb-0">{{ company_date_formate($project->start_date) }}</p>
                    </div>
                    <div class="status-wrp">
                        <span class="d-block">{{ __('Due Date') }}:</span>
                        <p class="mb-0">{{ company_date_formate($project->end_date) }}</p>
                    </div>
                    <div class="status-wrp">
                        <span class="d-block">{{ __('Total Members') }}:</span>
                        <p class="mb-0">{{ (int) $project->users->count() + (int) $project->clients->count() }}</p>
                    </div>
                    <div class="status-wrp ">
                        <span class="d-block">
...
@permission('project dashboard manage')

@include('taskly::projects.dashboard-modern')
                            ...
                            <div class="list-group-item p-2">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-2 overflow-hidden">
                                        <h6 class="m-0 team-member-name">{{ $user->name }}</h6>
                                        <p class="text-muted mb-0 team-member-email">{{ $user->email }}</p>
    ...
    <div class="card invoice-card">
        <div class="card-header p-3">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="text-end">
                    <a href="{{ route('purchase-invoice.index', ['site_id' => $project->id]) }}" class="btn btn-sm btn-primary">
                        {{ __('View All') }}
                    </a>
                </div>
            </div>
    ...
    <div class="card activity-card">
        <div class="card-header p-3">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="text-end">
                    <a href="{{ route('activities.index', ['site_id' => $project->id]) }}" class="btn btn-sm btn-primary">
                        {{ __('View All') }}
                    </a>
                </div>
            </div>
    ...
    <div class="card manpower-card">
        <div class="card-header p-3">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="text-end">
                    <a href="{{ route('manpower.index', ['site_id' => $project->id]) }}" class="btn btn-sm btn-primary">
                        {{ __('View All') }}
                    </a>
                </div>
            </div>
    ...
    <div class="card consumption-card">
        <div class="card-header p-3">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="text-end">
                    <a href="{{ route('daily-consumption.index', ['site_id' => $project->id]) }}" class="btn btn-sm btn-primary">
                        {{ __('View All') }}
                    </a>
                </div>
            </div>
    ...
    <div class="card">
        <div class="card-header p-3">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="text-end">
                    <a href="{{ route('material-transfer.index', ['site_id' => $project->id]) }}" class="btn btn-sm btn-primary">
                        {{ __('View All') }}
                    </a>
                </div>
            </div>
