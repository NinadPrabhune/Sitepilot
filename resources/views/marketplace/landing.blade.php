                ...
                <div class="row row-gap align-items-center">
                    <div class="col-md-6 col-12">
                        <div class="banner-content">
                            ...
                            <p>{{ __('Lay a solid foundation for your brand. Grab a high-converting web powered by a secure backend coupled with an intuitive eCommerce.') }}
                            </p>
                            <div class="btn-group">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 support-card">
                        <div class="support-card-inner">
                            ...
                            <div class="support-content">
                                ...
                                <p>{{ __('Give your customers a quick way to find the products they want. Thanks to a built-in, intuitive search and filtering, they can view only those products that they’re interested in.') }}
                                </p>
                            </div>
        ...
        <section class="dedicated-themes-section">
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <p> {{ __('With Dash, you can conveniently manage all your business functions from a single location.') }}
                    </p>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-6 col-12">
                            <div class="abt-theme">
                                ...
                                <p>{{ __('Manage your billing and accounting without little to no effort! Set financial goals and let the system monitor them for you, automate taxes, and more! - without lifting a finger.') }}
                                </p>
                                <div class="theme-acnav">
                                    <div class="set has-children">
                                        ...
                                        <div class="acnav-list">
                                            <p>{{ __('Simplify your accounting and make it easy to keep an eye on your money. Set financial goals and let the system monitor them for you, automate taxes, and more! - without lifting a finger.') }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="set has-children">
                                        ...
                                        <div class="acnav-list">
                                            <p>{{ __('Save time by managing your entire inventory with a few clicks. Easily create categories and add products to them. Modify product prices whenever you want, assign SKUs, create different tax rates, and do so much more!') }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="set has-children">
                                        ...
                                        <div class="acnav-list">
                                            <p>{{ __('Land new clients in a flash, and get paid just as fast. Create proposal templates and pitch your future clients. Turn your accepted proposals into payable invoices, send reminders, and get paid fast - all in one place!') }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-6 col-12">
                            <div class="abt-theme">
                                ...
                                <p>{{ __('This feature makes it easier for a company to maintain a record of an employee’s personal, company, and Bank details along with their essential documentation. Employees could view and manage their profiles.') }}
                                </p>
                                <div class="theme-acnav">
                                    <div class="set has-children">
                                        <a href="javascript:;" class="acnav-label">
                                        ...
                                        <div class="acnav-list">
                                            <p>{{ __('Create a profile for every employee, track their key information, and update the information in just a few clicks. Collect and analyze feedback about their work, including warnings and complaints issued by their managers or other employees.') }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="set has-children">
                                        ...
                                        <div class="acnav-list">
                                            <p>{{ __('Empower employee growth. Schedule skills training, track expenses, and watch your employees become better at their work. Boost employee productivity with custom KPIs. Track employee performance, share feedback, and help them reach company targets.') }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="set has-children">
                                        ...
                                        <div class="acnav-list">
                                            <p>{{ __('Pay your employees for their hard work. Keep data of all workforce costs, transfers, deposits, and other employee-related transactions for future reference. Track employee attendance and overtime to ensure they always receive fair compensation for their work.') }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-6 col-12">
                            <div class="abt-theme">
                                ...
                                <p>{{ __('Got a big team or working on multiple projects at once? Manage task priorities or even create additional workspaces and use the built-in permission system to separate core projects. Make your team more effective by helping them avoid confusion ensuring they always know what to focus on.') }}
                                </p>
                                <div class="theme-acnav">
                                    <div class="set has-children">
                                        <a href="javascript:;" class="acnav-label">
                                        ...
                                        <div class="acnav-list">
                                            <p>{{ __('Whether you need a simple tool to track your tasks, are a Kanban fan, want to create Gantt Charts or are looking for a convenient tool to track your projects - Taskly got you covered.') }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="set has-children">
                                        ...
                                        <div class="acnav-list">
                                            <p>{{ __('Add a new task to an already existing project and prioritize them according to the need of urgency. Assign the task to team members and set a due date for task completion. Add comments to the task and create a sub-task for ease of completion. Attach necessary files in a required task.') }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="set has-children">
                                        ...
                                        <div class="acnav-list">
                                            <p>{{ __('Create new bugs and assign users and priority to them. You can write a note in the text box for the bug description. Also, the status of each bug could be changed through an easy drop-down and Kanban drag system.') }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-6 col-12">
                            <div class="abt-theme">
                                ...
                                <p>{{ __('Skyrocket your sales with an effective lead management tool. Determine the value of leads and develop promising leads with ease. Get clearer action plans and make smarter and well-informed decisions.') }}
                                </p>
                                <div class="theme-acnav">
                                    <div class="set has-children">
                                        <a href="javascript:;" class="acnav-label">
                                        ...
                                        <div class="acnav-list">
                                            <p>{{ __('Manage your clients, users, and deals from anywhere, and from a single tab. Access a wide range of features, get a graphical representation of your data, and make informed decisions.') }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="set has-children">
                                        ...
                                        <div class="acnav-list">
                                            <p>{{ __('Save money and manage your time effectively to improve your business productivity. Automate your lead management and start closing more deals and making more sales on autopilot.') }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="set has-children">
                                        ...
                                        <div class="acnav-list">
                                            <p>{{ __('Easily measure every aspect of your business from an intuitive interface. Generate insights that lead to more effective sales, and manage your leads and deals with a smooth drag-and-drop system.') }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-6 col-12">
                            <div class="abt-theme">
                                ...
                                <p>{{ __('POS allows you to create and maintain the data of each customer and vendor. You get access to all essential information through a well-maintained format.') }}
                                </p>
                                <div class="theme-acnav">
                                    <div class="set has-children">
                                        <a href="javascript:;" class="acnav-label">
                                        ...
                                        <div class="acnav-list">
                                            <p>{{ __('Stay on top of your total and monthly purchases and sales. Get an interactive purchase and sales report graph to help you make informed decisions. Get progress reports of each branch, along with to-do lists and event calendars.') }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="set has-children">
                                        ...
                                        <div class="acnav-list">
                                            <p>{{ __('Create sales targets and keep track of their progress in your dashboard. Use the expense list to cut down on unnecessary expenses, and put more resources into reaching your sales targets.') }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="set has-children">
                                        ...
                                        <div class="acnav-list">
                                            <p>{{ __('Never stress about managing your inventory ever again! With PosGo, you can create your products and assign them a brand, category, unit and tax rate. You can even modify product descriptions, images, and price whenever you want.') }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
