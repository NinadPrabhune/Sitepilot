...
<div class="d-flex">
    ...
    @permission('spent create')
    <a data-size="xl" data-url="{{ route('spent.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Create')}}" data-title="{{__('Create Spent')}}" class="btn btn-sm btn-primary">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-end">
                    ...
                    <div class="col-xl-3 col-lg-12 col-12">
                        <div class="btn-box me-2">
                            {{ Form::label('project_filter', __('Project'), ['class' => 'form-label']) }}
