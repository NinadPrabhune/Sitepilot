                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    @permission('lead edit')
                                                                        <a data-url="{{ URL::to('leads/' . $lead->id . '/labels') }}"
                                                                            ...
                                                                            class="dropdown-item"><i class="ti ti-copy"></i> {{ __('Labels') }}</a>
                                                                    @endpermission
                                                                    @permission('lead show')
                                                                        @if($lead->is_active)
                                                                            <a href="{{route('leads.show',$lead->id)}}" class="dropdown-item" data-toggle="tooltip" data-original-title="{{__('View')}}" data-bs-placement="top"><i class="ti ti-eye"></i> {{ __('View') }}</a>
                                                                        @endif
                                                                    @endpermission
                                                                    @permission('lead edit')
                                                                        <a data-url="{{ URL::to('leads/' . $lead->id . '/edit') }}"
                                                                            ...
                                                                            class="dropdown-item"><i class="ti ti-pencil"></i> {{ __('Edit') }}</a>
                                                                    @endpermission
