...
class SupplierDataTable extends DataTable
{
    ...
    {
//        $supplierQuery = $model->where('created_by', '=', creatorId())->where('workspace_id',getActiveWorkSpace());
        
        $supplierQuery = $model->where('status', '=', '0');
        $supplierQuery = $supplierQuery->with(['category']);
        ...
        $exportButtonConfig = [
            ...
            'buttons' => [
                [
                    ...
                    'className' => 'btn btn-light text-primary dropdown-supplier',
