{{ Form::open(['route' => 'assets_tools_and_equipment.store', 'class' => 'needs-validation', 'novalidate']) }}
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <div class="input-group">
                {{ Form::number('quantity', 1, ['class' => 'form-control', 'required' => 'required', 'min' => 1]) }}
...
<script>
    $(document).ready(function () {
        ...
        // Trigger on page load if material is preselected
