                                                ...
                                                @foreach ($project->users as $user)
                                                    @if ($user->pivot->is_active)
                                                        <img alt="{{ $user->name }}" 
                                                             ...
                                                             title="{{ $user->name }}"
                                                             src="{{ check_file($user->avatar) ? get_file($user->avatar) : get_file('uploads/users-avatar/avatar.png') }}"
                                                             class="rounded-circle border border-white me-1">
                                                    @endif
                                                @endforeach
                                                <span class="ms-1">{{ __('Members') }}</span>
                                            </div>
                                        </div>
                        ...
                        <div class="col-xxl-3 col-xl-4 col-md-6 col-12 All Ongoing Finished OnHold">
                            <div class="project-card-inner">
                                <a href="javascript:void(0)" class="btn-addnew-project " data-ajax-popup="true" data-size="md"
                                    data-title="{{ __('Create New Project') }}" data-url="{{ route('projects.create') }}">
