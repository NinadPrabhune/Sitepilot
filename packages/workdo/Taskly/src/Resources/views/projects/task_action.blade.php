...
@permission('task manage')
    <div class="action-btn me-2">
        <a href="#" data-url="{{ route('tasks.reminder', [$task->project_id, $task->id]) }}"
            class="btn btn-sm align-items-center text-white bg-primary send-reminder-btn" data-bs-toggle="tooltip"
