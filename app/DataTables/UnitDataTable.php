...
class UnitDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        $dataTable = (new EloquentDataTable($query))
            ->addIndexColumn()
            ->addColumn('checkbox', function (Unit $unit) {
                return '<input type="checkbox" class="' . $this->getCheckboxClass() . ' form-check-input" value="' . $unit->id . '">';
            });

        $dataTable->addColumn('action', function (Unit $unit) {
    ...
    public function getColumns(): array
    {
        ...
        $column = [
            ...
            Column::make('symbol')->title(__('Symbol')),
