...
<!--            <a href="#"  class="btn btn-sm btn-primary me-2" data-ajax-popup="true" data-title="<?php echo e(__('Payment Import')); ?>" data-url="<?php echo e(route('machineries.file.import')); ?>"  data-toggle="tooltip" title="<?php echo e(__('Import')); ?>"><i class="ti ti-file-import"></i>
         </a>-->
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\SitePilot\resources\views/payments-module/index.blade.php ENDPATH**/ ?>