                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="row">
                                            ...
                                            <div class="choose-files mt-3">
                                                <label for="avatar">
                                                    ...
                                                    <input type="file" accept="image/png,image/gif,image/jpeg,image/jpg"
                                                           class="form-control" name="profile" id="avatar" data-filename="avatar-logo">
                                                </label>
                                            </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-icon-user">
                                            {{ Form::text('age', null, ['class' => 'form-control', 'id' => 'age', 'readonly' => true]) }}
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group col-12 d-flex">
                                            ...
                                            <div class="col-3 d-flex flex-column align-items-center">
                                                <img id="{{ 'blah' . $key }}" style="margin-left: 15px;"
                                                     src="{{ asset('images/material/No_Image_Available.jpeg') }}"
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        {!! Form::text('organisation_switch', old('organisation_switch'), [
                                        'class' => 'form-control',
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        {!! Form::text('provident_fund_no', old('provident_fund_no'), [
                                        'class' => 'form-control',
