...
class MaterialCategoryDataTable extends DataTable
{
    ...
    {
        return 'material-categories-table';
    }
    ...
    {
        return 'material-category-checkbox';
    }
    ...
    {
        return \App\Models\MaterialCategory::class;
    }
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        $dataTable = (new EloquentDataTable($query))
            ->addIndexColumn()
            ->addColumn('checkbox', function (MaterialCategory $MaterialCategory) {
                return '<input type="checkbox" class="' . $this->getCheckboxClass() . ' form-check-input" value="' . $MaterialCategory->id . '">';
            });

        $dataTable->addColumn('action', function (MaterialCategory $MaterialCategory) {
            return view('material-categories.action', compact('MaterialCategory'));
        });
        $rowColumn[] = 'action';
     ...
     */
    public function query(MaterialCategory $model): QueryBuilder
    {
    ...
    {
        return 'MaterialCategory_' . date('YmdHis');
    }
}
