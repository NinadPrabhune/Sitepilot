            ...
            <div class="col-xl-9">
                <div id="useradd-1">
                    <div class="card">
                        ...
                        {{ Form::model($userDetail, ['route' => ['edit.profile'], 'method' => 'post', 'enctype' => 'multipart/form-data','class'=>'needs-validation','novalidate']) }}
                        <div class="card-body">
                            @csrf
                            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        {{ Form::label('confirm_password', __('New Confirm Password'), ['class' => 'col-form-label text-dark']) }}
