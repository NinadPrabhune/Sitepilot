                ...
                <div class="card-body">
                    ...
                    <div class="row d-flex align-items-center justify-content-end">
                        ...
                        <div class="col-auto float-end mt-4 d-flex">
                            <a href="#" class="btn btn-sm btn-primary me-2" onclick="document.getElementById('customer_submit').submit(); return false;" data-toggle="tooltip" data-original-title="{{ __('Search') }}">
                                ...
                                <div class="project-card-inner">
                                    <div class="project-card-header d-flex justify-content-between">
                                        ...
                                        @elseif($invoice->status == 3)
                                            <span class="badge bg-danger p-2 px-3">{{ __(\App\Models\Invoice::$statues[$invoice->status]) }}</span>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end pointer">
                                            <a href="#"  data-link="{{route('pay.invoice',\Illuminate\Support\Facades\Crypt::encrypt($invoice->id))}}" class="dropdown-item cp_link" >
                                                <i class="ti ti-copy me-1"></i> {{__('Click To Copy Invoice Link')}}
                                            </a>
                                            ...
                                            <div class="comment d-flex align-items-center gap-2">
                                                ...
                                                {!! Form::open([
                                                    ...
                                                    'id' => 'duplicate-form-' . $invoice->id,
                                                        ...
                                                        <a href="#!" class="show_confirm btn btn-sm bg-secondary" data-text="{{ __('You want to confirm duplicate this invoice. Press Yes to continue or Cancel to go back') }}"
                                                        data-confirm-yes="duplicate-form-{{ $invoice->id }}">
