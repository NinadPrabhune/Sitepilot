            ...
            <div class="dashboard-card">
                ...
                <div class="card-inner">
                    <div class="card-content">
                        ...
                        <p>{{ __('WorkDo dash simplifies accounting with streamlined invoicing, bill tracking, and real-time financial insights') }}</p>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif($invoice->status == 2)
                                                    <span
                                                        class="p-2 px-3 badge bg-danger">{{ __(\App\Models\Invoice::$statues[$invoice->status]) }}</span>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif($bill->status == 2)
                                                    <span
                                                        class="p-2 px-3 badge bg-danger">{{ __(\Workdo\Account\Entities\Bill::$statues[$bill->status]) }}</span>
