 ...
 * Endpoints for lead management including lead board, creation, and updates
 */
class LeadApiController extends Controller
{
     ...
     * @bodyParam pipeline_id integer required Pipeline ID. Example: 1
     * @bodyParam phone string required Phone number (min 9 digits). Example: +91-9876543210
     * @bodyParam subject string required Lead subject. Example: Product Inquiry
     * @bodyParam name string required Lead name. Example: John Doe
     * @bodyParam email required Email address. Example: john@example.com
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            if (empty($stage)) {
                ...
                if ($objUser->isAbleTo('lead manage')) {
