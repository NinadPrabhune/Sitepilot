...
class OrderDataTable extends DataTable
{
    ...
    {
        $rowColumn = ['order_id', 'created_at', 'price', 'payment_status', 'coupon_code', 'receipt', 'action', 'checkbox'];

        return (new EloquentDataTable($query))
            ->addIndexColumn()
            ->addColumn('checkbox', function (Order $order) {
                return '<input type="checkbox" class="' . $this->getCheckboxClass() . ' form-check-input" value="' . $order->id . '">';
            })
    ...
    public function query(Order $model): QueryBuilder
    {
        ...
        $this->handleSelectedIdsFilter($orders);
    ...
    public function getColumns(): array
    {
        ...
        $column =  [
            ...
            Column::make('coupon_code')->title(__('Coupon'))->orderable(false),
