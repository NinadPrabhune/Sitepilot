...
//                ->editColumn('clock_in', fn(Attendance $attendances) => $attendances->clock_in ?? '-')
//                ->editColumn('clock_out', fn(Attendance $attendances) => $attendances->clock_out ?? '-')
     ...
     */
    public function query(Attendance $model, Request $request): \Illuminate\Database\Eloquent\Builder
{
        
//        dd($request->employee);
    // Base query: eager load employee + project relations
        ...
        $dataTable = $this->builder()
                ...
                ->ajax([
                    'data' => 'function(d) {
                        ...
                        // (Remove branch/department if you no longer use them)
    ...
    public function getColumns(): array {
        ...
        if (
            ...
            $employee = [
                ...
                Column::make('site_id')->title(__('Project')), // 👈 added project column
            ];
