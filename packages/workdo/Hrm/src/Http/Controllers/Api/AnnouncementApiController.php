...
class AnnouncementApiController extends Controller {
     ...
     *
     * @bodyParam title string required Announcement title. Example: Company Holiday
     ...
     * @bodyParam end_date date required End date (must be after or equal to start_date). Example: 2024-01-20
     * @bodyParam description string required Announcement description. Example: Office will be closed for holidays
