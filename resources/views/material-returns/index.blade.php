...
<div class="d-flex">
    ...
    <a data-size="xl" data-url="{{ route('material-returns.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" data-bs-original-title="{{__('Create Material Return')}}" title="{{__('Create Material Return')}}" data-title="{{__('Create Material Return')}}" class="btn btn-sm btn-primary">
...
$(document).on('click', '#applyfilter', function() {
    $('#material-returns-table').DataTable().draw();
});
