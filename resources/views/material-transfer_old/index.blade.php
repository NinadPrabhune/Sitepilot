...
<div class="d-flex">
    ...
    <a data-size="xl" data-url="{{ route('material-transfer.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Create')}}" data-title="{{__('Create Material Transfer')}}"  class="btn btn-sm btn-primary">
