                        ...
                        <div class="col-xl-10">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                    <div class="btn-box">
                                        @if(Auth::user()->type=='super admin')
                                        {{ Form::label('users', __('Customer'),['class'=>'form-label']) }}
                                        @else
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-btn me-2">
                                        <a href="#" class="mx-3 btn btn-sm align-items-center bg-warning" data-size="lg" data-url="{{ route('users.userlog.view', [$user->id]) }}" data-ajax-popup="true" data-size="md" data-bs-toggle="tooltip" title="" data-title="{{ __('View User Logs') }}" data-bs-original-title="{{ __('View') }}">
                                    ...
                                    <div class="action-btn">
                                        ...
                                        @method('DELETE')
                                        <a href="#" class="mx-3 btn btn-sm  align-items-center bs-pass-para show_confirm bg-danger" data-bs-toggle="tooltip" title="" data-bs-original-title="{{__('Delete')}}" aria-label="{{__('Delete')}}" data-confirm-yes="delete-form-{{ $user->id }}"><i class="ti ti-trash text-white text-white"></i></a>
                                        {{ Form::close() }}
                                    </div>
                                    @endpermission
                                </td>
