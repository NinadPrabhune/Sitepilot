                        ...
                        <div class="dashboard-project-card">
                            <div class="card-inner  d-flex justify-content-between">
                                <div class="card-content">
                                    ...
                                    <a href="{{ route('purchase-invoice.index') }}"><h3 class="mt-3 mb-0 text-danger">{{ __('Total Material') }}</h3>
                                </div>
                                <h3 class="mb-0">{{ $totalMaterials }}</h3></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3 col-12">
                        ...
                        <div class="dashboard-project-card">
                            <div class="card-inner  d-flex justify-content-between">
                                <div class="card-content">
                                    ...
                                    <a href="{{ route('purchase-invoice.index') }}"><h3 class="mt-3 mb-0">{{ __('Total Supplier') }}</h3></a>
                                </div>
                                <h3 class="mb-0">{{ $uniqueSupplierCount }}</h3>
                            </div>
                        </div>
                    </div>
                 <div class="col-sm-3 col-12">
