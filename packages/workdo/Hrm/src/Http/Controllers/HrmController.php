...
//                $holidays = \Workdo\Hrm\Entities\Holiday::where('created_by', '=', creatorId())->where('workspace', getActiveWorkSpace());
                $holidays = \Workdo\Hrm\Entities\Holiday::where('workspace', getActiveWorkSpace());
...
//                $hrm_events = \Workdo\Hrm\Entities\Event::where('created_by', '=', creatorId())->where('workspace', getActiveWorkSpace());
                $hrm_events = \Workdo\Hrm\Entities\Event::where('workspace', getActiveWorkSpace());
...
//                } else {
                    ...
                    $emp           = User::where('site_id', getActiveProject())->get()->toArray();
