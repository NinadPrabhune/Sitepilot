...
class ReportController extends Controller
{
    ...
    {
        // Debug log - Route access tracking
        \Log::info('attendance.monthly-report-new route accessed', [
            'user_id' => Auth::id(),
        ...
        if (Auth::user()->isAbleTo('attendance monthly-report')) {
            \Log::info('Permission check passed for attendance monthly-report', [
                'user_id' => Auth::id(),
            ...
            \Log::info('Monthly attendance report generated successfully', [
                'user_id' => Auth::id(),
                'employees_count' => count($employeesAttendance ?? []),
