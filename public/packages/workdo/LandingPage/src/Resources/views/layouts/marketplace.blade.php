            ...
            <div class="container">
                <div class="footer-top">
                    ...
                    <div class="footer-top-right">
                        <ul>
                            <li>
                                <a href="{{ $settings['footer_live_demo_link'] }}" class="btn-secondary">{{ $settings['footer_gotoshop_button_text'] }}<svg
                            ...
                            <li>
                                <a href="{{ $settings['footer_support_link'] }}" class="btn-link"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                        ...
                                        <path
                                            ...
                                            fill="#6FD943" />
                                    </svg>{{  $settings['footer_support_button_text'] }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
