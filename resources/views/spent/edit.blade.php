{{ Form::model($spent, ['route' => ['spent.update', $spent->id], 'method' => 'PUT', 'class' => 'needs-validation', 'novalidate']) }}
    ...
    <div class="row">
        <div class="form-group col-md-6">
         ...
         <div class="form-group col-md-6">
            ...
            {{ Form::text('project_name', optional($spent->project)->name ?? '', ['class' => 'form-control', 'readonly' => true]) }}
        </div>
