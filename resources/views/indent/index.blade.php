...
<div class="d-flex">
    ...
    <a data-size="xxl" data-url="{{ route('indent.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Create')}}" data-title="{{__('Create Indent')}}" class="btn btn-sm btn-primary">
