...
Route::group(['middleware' => ['web', 'auth', 'verified','PlanModuleCheck:Hrm']], function () {
    ...
    // Attendance
    Route::get('attendance/monthly-report-new', [ReportController::class, 'monthlyAttendance'])->name('attendance.monthly-report-new');
    Route::get('attendance/details', [ReportController::class, 'getAttendanceDetails'])->name('attendance.details');
    Route::get('leave/details', [ReportController::class, 'getLeaveDetails'])->name('leave.details');
    ...
    Route::get('/leave/{id}/status_reason', [LeaveController::class,'status_reason'])->name('leave.status_reason');
