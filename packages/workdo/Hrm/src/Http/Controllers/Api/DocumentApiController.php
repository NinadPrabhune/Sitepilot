...
//                ->get();
     ...
     *
     * @bodyParam name string required Document name. Example: Employee Handbook
     * @bodyParam documents file required Document file.
     * @bodyParam description string optional Description. Example: Company policies
