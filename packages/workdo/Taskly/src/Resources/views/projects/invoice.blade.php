                    ...
                    <div class="row">
                        ...
                        @permission('invoice create')
                            <div class=" col-1 text-end">
                                <a href="{{ route('invoice.create', ['cid' => 0,'type' => 'project', 'project_id' => $project->id ,'redirect_route' =>route('projects.invoice', $project->id)] ) }}
                                        ...
                                        <td class="Action">
                                            <span>
                                                <div class="action-btn me-2">
                                                    <a href="#" class="btn btn-sm  align-items-center cp_link bg-primary" data-link="{{route('pay.invoice',\Illuminate\Support\Facades\Crypt::encrypt($invoice->id))}}" data-bs-toggle="tooltip" title="{{__('Copy')}}" data-original-title="{{__('Click to copy invoice link')}}">
                                                ...
                                                @endif
                                                <div class="action-btn me-2">
                                                    <a href="#" class="btn btn-sm  align-items-center bg-info" data-url="{{route('delivery-form.pdf',\Crypt::encrypt($invoice->id))}}" data-ajax-popup="true" data-size="lg" data-bs-toggle="tooltip" title="{{__('Invoice Delivery Form')}}" data-title="{{ __('Invoice Delivery Form') }}">
