                                                                        ...
                                                                        @foreach ($permissions as $key => $prermission)
                                                                            ...
                                                                            @if ($list == $check)
                                                                                <div class="col-xl-3 col-sm-6 form-check mb-2">
                                                                                    {{ Form::checkbox('permissions[]', $prermission->id, $role->hasPermission($prermission->name), ['class' => 'form-check-input pointer checkbox-' . strtolower($module) . ' auto-select-admin-company', 'id' => 'permission_' . $key . '_' . $prermission->id, 'data-role-check' => 'true']) }}
