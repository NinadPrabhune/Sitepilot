...
class ProjectReportController extends Controller
{
    ...
    public function show(Request $request,$id)
    {
        ...
        if ($project) {
            ...
            $project_status_task = stage::join("tasks", "tasks.status", "=", "stages.id")->where('tasks.project_id', '=', $id)->groupBy('name')->selectRaw('count(tasks.id) as count, name')->pluck('count', 'name');
