...
class MachineryCategoryDataTable extends DataTable
{
    ...
    {
        return 'machinery-categories-table';
    }
    ...
    {
        return 'machinery-category-checkbox';
    }
    ...
    {
        return \App\Models\MachineryCategory::class;
    }
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        $dataTable = (new EloquentDataTable($query))
            ->addIndexColumn()
            ->addColumn('checkbox', function (MachineryCategory $category) {
                return '<input type="checkbox" class="' . $this->getCheckboxClass() . ' form-check-input" value="' . $category->id . '">';
            })
            ->editColumn('description', function (MachineryCategory $category) {
                return $category->description;
            });

        $dataTable->addColumn('action', function (MachineryCategory $MachineryCategory) {
            return view('machinery-categories.action', compact('MachineryCategory'));
        });
        $rowColumn[] = 'action';
     ...
     */
    public function query(MachineryCategory $model): QueryBuilder
    {
    ...
    {
        return 'MachineryCategory_' . date('YmdHis');
    }
}
