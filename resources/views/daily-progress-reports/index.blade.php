...
<!--          <a data-size="xl"
               data-url="{{ route('daily-progress-reports-new.createdpr') }}"
               data-ajax-popup="true"
               data-bs-toggle="tooltip"
               data-toggle="tooltip"
               title="{{ __('Create') }}"
               data-title="{{ __('Create Daily Progress Report') }}"
...
$(document).on('change','#select-all-daily-progress-checkbox',function(){
    $('.daily-progress-checkbox').prop('checked',$(this).prop('checked'));
});
</script>
@endpush
