...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('machinery_ledger', function (Blueprint $table) {
            // Source tracking
            if (!Schema::hasColumn('machinery_ledger', 'source_type')) {
            ...
            if (!Schema::hasColumn('machinery_ledger', 'is_reversed')) {
            ...
            if (!Schema::hasColumn('machinery_ledger', 'site_id')) {
        ...
        DB::statement("UPDATE machinery_ledger SET source_type = 'activity' WHERE source_type IS NULL OR source_type = ''");
        DB::statement("UPDATE machinery_ledger SET is_settled = false WHERE is_settled IS NULL");
        DB::statement("UPDATE machinery_ledger SET is_reversed = false WHERE is_reversed IS NULL");
    }
