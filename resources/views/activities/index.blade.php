...
@section('page-action')
    <div class="d-flex">
        ...
        {{-- @permission('activity create') --}}
             <a data-size="xl" data-url="{{ route('activities.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Create')}}" data-title="{{__('Create Activity')}}" class="btn btn-sm btn-primary">
