...
<?php echo e(__('Manage Payment Request')); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startPush('script-page'); ?>
<?php $__env->stopPush(); ?>
<?php $__env->startSection('page-breadcrumb'); ?>
<?php echo e(__('Payment Requests')); ?>
...
<div class="d-flex">
    ...
    <?php if (app('laratrust')->hasPermission('payment-request create')) : ?>
    <a data-size="xl" data-url="<?php echo e(route('payment-request.create')); ?>" 
       data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>" 
       data-title="<?php echo e(__('Create Payment Request')); ?>" class="btn btn-sm btn-primary">
                ...
                <div class="d-flex align-items-center justify-content-end">
                    <div class="col-xl-2 col-lg-12 col-12">
                        <div class="btn-box me-2">
                            <?php echo e(Form::label('requested_date', __('Requested Date'), ['class' => 'form-label'])); ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\SitePilot\resources\views/payment-request/index.blade.php ENDPATH**/ ?>